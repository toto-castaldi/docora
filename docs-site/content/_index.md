...
1. **Get onboarded** -- A Docora admin registers your app through the admin dashboard and provides you with an app ID and bearer token. Docora uses these credentials to authenticate your API calls and sign webhook deliveries.
